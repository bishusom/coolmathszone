...
export default function Layout({ 
  children, 
  title = 'CoolMathsZone',
  backgroundClass = 'bg-gradient-to-br from-blue-50 via-cyan-50 to-emerald-50'
}: LayoutProps) {
  return (
    <div className={`min-h-screen ${backgroundClass} relative overflow-hidden`}>
      {/* Ocean background elements - only show on default or specific pages if they look good */}
