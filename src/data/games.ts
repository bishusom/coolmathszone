...
export const games: GameEntry[] = [
  ...
  {
    slug: 'number-arranger',
    title: 'Number Arranger',
    heading: 'Number Arranger Challenge',
    description: 'Slide tiles and master sequences in this classic numerical grid puzzle. Arrange numbers by value and patterns to win.',
    difficulty: 'Intermediate',
    grade: 'Elementary / Middle',
    icon: '🔢',
    color: 'from-indigo-400 to-blue-600',
    buttonColor: 'bg-indigo-600 hover:bg-indigo-500',
    skill: 'Numerical Sequences & Logic',
    howToPlay: 'Click tiles adjacent to the empty slot to slide them. Arrange the grid to match the target sequence (Arithmetic, Multiples, or Powers) starting from the top-left.',
  },
  {
    slug: 'number-scramble',
    title: 'Number Scramble',
    heading: 'Math Bubble Scramble',
    description: 'Pop the floating bubbles in the right order to rebuild the equation and reach the target number. Perfect for early math learners!',
    difficulty: 'Beginner',
    grade: 'Elementary',
    icon: '🫧',
    color: 'from-blue-400 to-cyan-600',
    buttonColor: 'bg-blue-600 hover:bg-blue-500',
    skill: 'Foundation Arithmetic',
    howToPlay: 'Look at the target number, then tap the number and operator bubbles to build an equation that matches. Use all the bubbles to solve the level!',
  },
  {
    slug: 'math-popper',
    title: 'Math Popper',
